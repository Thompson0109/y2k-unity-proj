...
public class TimeManager : MonoBehaviour
{
    ...
    private void OnHoursChange(int value)
    {
        ...
        else if (value == 18)
        {
            ...
            StartCoroutine(LerpLight(graddientDayToSunset, 30f));
        }
        else if (value == 22)
        {
            StartCoroutine(LerpSkybox(skyboxSunset, skyboxNight, 30f));
            StartCoroutine(LerpLight(graddientSunsetToNight, 30f));
        }
    }
